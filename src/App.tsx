...
function App() {
  ...
  const [currentView, setCurrentView] = useState<'dashboard' | 'exam' | 'results' | 'create'>('dashboard');
  ...
  const viewResults = (submission: Submission) => {
    ...
    <ErrorBoundary>
      <LoadingProvider>
        <div className="min-h-screen bg-background">
          ...
          {currentView === 'results' && selectedSubmission && (
            <ResultsPage 
