              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-center">
                    ...
                    <span className="text-2xl text-red-600">{submission.totalQuestions - submission.score}</span>
                  </div>
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-center">
                    ...
                    <span className="text-2xl text-blue-600">{submission.totalQuestions}</span>
                  </div>
