          ...
          <body>
            ...
            <div class="exam-info">
              ...
              <div class="qr-section">
                <div class="qr-code">
                  <img src="${qrCodeUrl}" alt="QR Code da Avaliação" />
                </div>
                <p><small>Escaneie para acessar online</small></p>
              </div>
            </div>
            ...
            <div class="instructions">
              ...
              <ul>
                ...
                <li>Para acessar online, escaneie o QR Code acima</li>
              </ul>
            </div>
        ...
        <Card className="seice-card">
          <CardContent className="p-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm font-medium text-slate-600">QR Codes Gerados</p>
                <p className="text-2xl font-semibold text-slate-800">
                  {exams.filter(exam => exam.status === 'Ativo').length}
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="text-xs text-slate-500 p-3 bg-slate-50 rounded-lg">
                ...
                <ul className="mt-1 space-y-1">
                  <li>• Inclua o QR code nas provas impressas</li>
                  <li>• Alunos podem escanear para acessar a versão online</li>
                  <li>• O link expira automaticamente após o prazo</li>
                </ul>
              </div>
            </div>
          )}
